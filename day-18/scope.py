#varible declared inside function and can be acccessed inside 
# the function not outside the function=> LOCAL VARIABLE 
#varible declared outside function 
# it can be accesed any whr in prgm  => GLOBAL VARIABLE 
'''
def display():
